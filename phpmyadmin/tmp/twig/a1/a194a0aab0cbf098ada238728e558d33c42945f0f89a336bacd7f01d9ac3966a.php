...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/www/mycscenter.godohosting.com/phpmyadmin/templates/database/structure/bulk_action_modal.twig");
    }
}
